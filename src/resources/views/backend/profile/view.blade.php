              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="description-block">
                    ...
                    <span class="description-text">{{$user->profile_data->mobile}}</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4 br-1 bl-1">
                  <div class="description-block">
                    ...
                    <span class="description-text">{{$user->profile_data->address}}</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4">
                  <div class="description-block">
                    ...
                    <span class="description-text">{{$user->profile_data->gender}}</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
